				...
				<div className="flex flex-col items-center fade-in-text lg:text-center">
					...
					<div className="flex flex-col text-center">
						<p className="text-lg mt-4">
							Front-end developer and UI/UX designer based in the
							philippines,
						</p>
						<p className="text-lg ">
							I&apos;m currently running a small business which is
							Afforda Pc Workshop as a Computer Technician.
						</p>
					</div>
				</div>
				<div>
						...
						>
							<div className="w-full mx-auto flex flex-row gap-5 bg-secondary p-4 rounded-lg hover:bg-accent">
								...
								<div className=" flex max-h-full items-center  flex-col gap-2 lg:flex-row ">
									...
									<p>
										A JavaScripts Library for building user
										interfaces.{" "}
									</p>
								</div>
							</div>
							...
							<div className="w-full mx-auto flex flex-row gap-5 bg-secondary p-4 rounded-lg hover:bg-accent">
								...
								<div className=" flex max-h-full items-center  flex-col gap-2 lg:flex-row ">
									...
									<p>
										...
										that builds on JavaScript, giving you
						...
						>
							<div className="w-full mx-auto flex flex-row gap-5 bg-secondary p-4 rounded-lg hover:bg-accent">
								...
								<div className=" flex max-h-full items-center  flex-col gap-2 lg:flex-row ">
									...
									<p>
										The ultimate React framework that
										enables developers to build web
						...
						>
							<div className="w-full flex flex-row gap-5 bg-secondary p-4 rounded-lg hover:bg-accent">
								...
								<div className=" flex max-h-full items-center  flex-col gap-2 lg:flex-row ">
									...
									<p>
										A vector graphics editor and prototyping
						...
						<div className="w-full grid grid-cols-1 lg:grid-cols-2 py-5 gap-5">
							<div className="bg-secondary rounded-xl px-5 py-4">
								...
								<p className="mt-2 line-clamp-6">
									I studied in the University of Caloocan
									City, taking up Bachelor of Science in
									Computer Science. I graduated last June
									2023.
								</p>
							</div>
							<div className="bg-secondary rounded-xl px-5 py-4">
								...
								<p className="mt-2">
									I focused on UI/UX Designer using Next.js
									and Tailwind CSS,also I&apos;m Computer
									Technician and I made a small business
									called Afforda Pc Workshop where I accepts
									repair and assemble personal computers from
									my clients based on their budget.
								</p>
							</div>
							<div className="bg-secondary rounded-xl px-5 py-4">
								<h3 className="text-2xl font-bold">
								...
								<p className="mt-2">
									To me, education plays a crucial role in
									honing not only skills but also ethical
									values, preparing individuals to navigate
									real-life challenges—an arena I often refer
					...
					<TabsContent value="personal" className="fade-in-text">
						<div className="w-full grid grid-cols-1 lg:grid-cols-2 py-5 gap-5">
							<div className="bg-secondary rounded-xl px-5 py-4">
								...
								<p className="mt-2">
									When it comes to Filipino grub, I&apos;m all
									about that &bdquo;Adobo,&bdquo;
									&bdquo;Sinigang,&bdquo; and
									&bdquo;Kare-Kare&bdquo; life—especially when
									it&apos;s whipped up by the folks I love.
							...
							<div className="bg-secondary rounded-xl px-5 py-4">
								...
								<p className="mt-2">
									I&apos;m all about chasing my dream job as a
									pro web developer. The plan? Stack up some
									savings, kickstart my own small business,
									and eventually open up a sweet computer
									store. I&apos;m all about that tech life!
								</p>
							</div>
							<div className="bg-secondary rounded-xl px-5 py-4">
								<h3 className="text-2xl font-bold">
								...
								<p className="mt-2">
									My biggest fear I guess is deep ocean&apos;s
									since I have thalassophobia.
								</p>
							</div>
							<div className="bg-secondary rounded-xl px-5 py-4">
								<h3 className="text-2xl font-bold">
								...
								<p className="mt-2">
									My hobbies include basketball and playing
									games on both my computer and mobile— you
									know, stuff like League of Legends, Mobile
									Legends, Clash of Clans, and Dota 2. .
								</p>
							</div>
							<div className="bg-secondary rounded-xl px-5 py-4">
								<h3 className="text-2xl font-bold">
									If you could be an animal for a day, what
									would you be and why?
								</h3>
								<p className="mt-2">
									If I could be any animal for a day, I&apos;d
									totally pick a bird. I mean, flying in the
									sky, checking out the world from above, and
									skipping traffic – that would be the great!
								</p>
							</div>
						</div>
					</TabsContent>
					<TabsContent value="work" className="fade-in-text">
						<div className="w-full grid grid-cols-1 lg:grid-cols-2 py-5 gap-5">
							<div className="bg-secondary rounded-xl px-5 py-4">
								...
								<p className="mt-2">
									• Accept client desktop and laptop for
									repairs
								</p>
								<p className="mt-2">
									• Disassembled System unit to diagnose
									issues and make selected repairs
								</p>
								<p className="mt-2">
									• Break down systems, remove malfunctioning
									hardware, and install new parts.
								</p>
								<p className="mt-2">
									• Provided computer repair services to small
							...
							<div className="bg-secondary rounded-xl px-5 py-4">
								...
								<p className="mt-2">
									• Calling a customer to validate their
									information in our database
								</p>
								<p className="mt-2">
									• Check and correct their Customer Master
									Data
								</p>
								<p className="mt-2">
									• Scanning and organize the customer
									requirements and upload it through online.
								</p>
								<p className="mt-4 italic">
